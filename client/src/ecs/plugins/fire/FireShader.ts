 ...
 *
 * Based on:
 * - Alfred et al. Real-Time procedural volumetric fire
 *   http://dl.acm.org/citation.cfm?id=1230131
 * - webgl-noise
 *   https://github.com/ashima/webgl-noise/blob/master/src/noise3D.glsl
 * - primitive: blog | object space raymarching
 *   https://github.com/ashima/webgl-noise/blob/master/src/noise3D.glsl
 */
...
export const FireShader = {
  ...
  fragmentShader: [
    ...
    "  float rayLen = 0.0288 + (0.01 * blaze) * length(scale.xyz);", // 0.0288
