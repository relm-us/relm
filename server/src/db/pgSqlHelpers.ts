 ...
 * @return {sql}
 */
export function AND(ident: any, params: any, options: { keyword?: string; delimiter?: string } = {}): any {
 ...
 * @return {sql}
 */
export function OR(ident: any, params: any, options: { keyword?: string; delimiter?: string } = {}) {
...
export function COLUMN(table: string, column?: string): any {
  ...
  const ref = table ? sql`${sql.ident(table, column)}` : sql`${sql.ident(column)}`
 ...
 */
export function SELECT(table: string, values: Object | Object[] | string[]): any {
  if (table != null && !is.string(table)) {
    values = table
    table = null
  }
 ...
 * @return {sql}
 */
export function WHERE(ident: string, params?: Object, options: { keyword?: string; delimiter?: string } = {}): any {
  if (is.object(ident)) {
    params = ident
    ident = ""
  }
