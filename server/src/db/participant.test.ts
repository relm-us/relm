...
describe("Participant model tests", () => {
  ...
  it("sets and gets public key document", async () => {
    ...
    expect(Participant.addPubKeyDoc({ participantId, pubKeyDoc })).rejects.toThrow("duplicate key")
  ...
  it("finds or creates verified pubKey", async () => {
    ...
    const x2 = "jTyjqvWMYYz_yQKGxvuGkaf5ielpjmStj3NYHCit8JKjQxP-ivuyzhGXiW0nCAhB"
    const y2 = "3RCyHuYhaEBqdxB4-g6Gm8qZ_TePf5a5lcTJvsf0D9GdFgyJ5vT_T0iWHgYh-3-e"
    const sig2 =
